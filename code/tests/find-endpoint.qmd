...
the code below is used to find the endpoints of a ORCP network 
the extract_junctions function is waiting for conversion to R code
...
```
the code below is used to find the nearest points between the endpoints identified above and OS networks
...
the code below is continue from previous step to find nearest points in OSM networks
...
the code below plot the OSM data, junction points, and nearest points
...
the code below is used to find the shortest path between the nearest points and junction points
