...
The above shows that there are 5 groups. Let's try to get them all into the same group, with reference to code here: https://github.com/cyipt/popupCycleways/blob/master/code/build.R#L175

```{r}
#| label: cycle_net_touching_100m
...
We can see with an interactive map that all the edges are connected in the meadows area.

```{r}
#| label: cycle_net_meadows_interactive
