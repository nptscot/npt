...
The output of the SIM model, for `r parameters$local_authority` is shown below.
...
#   sample_n(1000) |>
#   plot()
combined_old_edinburgh = combined_old[edinburgh, ]
combined_old_edinburgh = combined_old_edinburgh |>
  transmute(utility_increase = utility_fastest_bicycle_go_dutch / utility_fastest_bicycle)
summary(combined_old_edinburgh$utility_increase)

# The new data:
list.files("outputdata/2024-05-25/edinburgh_and_lothians/")
combined_new = sf::read_sf("outputdata/2024-05-25/edinburgh_and_lothians/combined_network_tile.geojson")
combined_new_edinburgh = combined_new[edinburgh, ]
combined_new_edinburgh = combined_new_edinburgh |>
  transmute(utility_increase = utility_fastest_bicycle_go_dutch / utility_fastest_bicycle)
summary(combined_new_edinburgh$utility_increase)
```

```{r}
#| label: route-network-results
brks = c(0, 10, 20, 30, 50)
combined_old_edinburgh |>
