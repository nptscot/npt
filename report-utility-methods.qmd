...
purpose_distance_modelled = tibble::tribble(
  ...
  "Commuting (observed)", mean_distance_observed, dd_data$proportion[2], dd_data$proportion[3] + dd_data$proportion[4],
  "Commuting (modelled)", mean_distance_modelled, dd_data$m1[2], dd_data$m1[3] + dd_data$m1[4]
)
